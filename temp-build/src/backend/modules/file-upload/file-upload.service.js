...
var FileUploadService = function () {
    ...
    var FileUploadService = _classThis = /** @class */ (function () {
        ...
        FileUploadService_1.prototype.ensureUploadDir = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _b.trys.push([0, 2, , 4]);
                            return [4 /*yield*/, fs_1.promises.access(this.uploadDir)];
                        case 1:
                            _b.sent();
                            return [3 /*break*/, 4];
                        case 2:
                            _a = _b.sent();
                            return [4 /*yield*/, fs_1.promises.mkdir(this.uploadDir, { recursive: true })];
                        case 3:
                            _b.sent();
                            return [3 /*break*/, 4];
        ...
        FileUploadService_1.prototype.saveCV = function (file) {
            return __awaiter(this, void 0, void 0, function () {
                var allowedTypes, maxSize;
        ...
        FileUploadService_1.prototype.deleteCV = function (filename) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!filename)
                                return [2 /*return*/];
                            filepath = (0, path_1.join)(this.uploadDir, filename);
                            _a.label = 1;
                        case 1:
                            _a.trys.push([1, 3, , 4]);
        ...
        FileUploadService_1.prototype.getCVPath = function (filename) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            error_2 = _a.sent();
                            console.error('Error accessing file:', error_2);
                            return [2 /*return*/, null];
                        case 4: return [2 /*return*/];
                    }
                });
        ...
        FileUploadService_1.prototype.deleteFile = function (filepath) {
            return __awaiter(this, void 0, void 0, function () {
                var error_3;
                return __generator(this, function (_a) {
                    switch (_a.label) {
