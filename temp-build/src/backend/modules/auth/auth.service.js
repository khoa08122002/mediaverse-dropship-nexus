    ...
    var AuthService = _classThis = /** @class */ (function () {
        ...
        AuthService_1.prototype.validateUser = function (email, password) {
            return __awaiter(this, void 0, void 0, function () {
                var user, isPasswordValid, _, result;
        ...
        AuthService_1.prototype.refresh = function (refreshDto) {
            return __awaiter(this, void 0, void 0, function () {
                var decoded, user, payload, accessToken, newRefreshToken, error_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            decoded = this.jwtService.verify(refreshDto.refreshToken, {
                                secret: process.env.JWT_REFRESH_SECRET || 'your-refresh-secret',
                            });
        ...
        AuthService_1.prototype.changePassword = function (changePasswordDto) {
            return __awaiter(this, void 0, void 0, function () {
