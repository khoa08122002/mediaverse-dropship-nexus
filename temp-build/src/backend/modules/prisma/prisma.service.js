...
var PrismaService = function () {
    ...
    var PrismaService = _classThis = /** @class */ (function (_super) {
        ...
        function PrismaService_1(configService) {
            ...
            var dbUrl = _this.configService.get('DATABASE_URL');
            _this.logger.debug("Database URL configured: ".concat(dbUrl ? 'Yes' : 'No'));
            return _this;
        }
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            error_1 = _a.sent();
                            this.logger.error('Failed to connect to the database:', error_1);
                            throw error_1;
