...
var UserService = function () {
    ...
    var UserService = _classThis = /** @class */ (function () {
        ...
        UserService_1.prototype.update = function (id, data) {
            return __awaiter(this, void 0, void 0, function () {
                var user, _a;
        ...
        UserService_1.prototype.updatePassword = function (id, hashedPassword) {
            return __awaiter(this, void 0, void 0, function () {
                var user;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                            ...
                            return [2 /*return*/, this.prisma.$transaction(function (prisma) { return __awaiter(_this, void 0, void 0, function () {
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            ...
                                            return [4 /*yield*/, prisma.blog.deleteMany({
                                                    where: { authorId: id }
                                                })];
                                            case 1:
                                                // Xóa tất cả các blogs của user
        ...
        UserService_1.prototype.searchUsers = function (query) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.user.findMany({
                            where: {
        ...
        UserService_1.prototype.changePassword = function (userId, currentPassword, newPassword) {
            return __awaiter(this, void 0, void 0, function () {
