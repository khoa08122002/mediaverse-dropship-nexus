...
var HealthService = function () {
    ...
    var HealthService = _classThis = /** @class */ (function () {
        function HealthService_1(prisma) {
            this.prisma = prisma;
            this.logger = new common_1.Logger(HealthService.name);
        }
        HealthService_1.prototype.check = function () {
            return __awaiter(this, void 0, void 0, function () {
                var appStatus, dbStatus, error_1, error_2;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            ...
                            this.logger.warn("Database health check failed: ".concat(error_1.message));
                            return [3 /*break*/, 4];
                        case 4: return [2 /*return*/, __assign(__assign({}, appStatus), { checks: {
                                    database: dbStatus
                                } })];
                        case 5:
                            error_2 = _a.sent();
                            this.logger.error("Health check failed: ".concat(error_2.message));
